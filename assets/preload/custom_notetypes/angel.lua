function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'angel' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'Dee_notes'); --Change texture

setPropertyFromGroup('unspawnNotes', i, 'noteSplashTexture', 'Tweedle_static');
			setPropertyFromGroup('unspawnNotes', i, 'hitHealth', '0.04');
